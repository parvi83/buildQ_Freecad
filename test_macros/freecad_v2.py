...
bottom_edge_angle = 3
bottom_edge_angle_rad = math.radians(bottom_edge_angle)
bottom_edge_angle_deg = math.degrees(bottom_edge_angle_rad)
...
for i in range(num_boards):
    ...
    points.append(App.Vector(0, bottom_t + top_t, z_base + bottom_edge_angle_deg))
    points.append(App.Vector(0, top_t, z_top))
    
    # p1 = App.Vector(0, 0, z_base)             # Bottom back
    # p2 = App.Vector(0, 0, z_top)              # Top back
    # p3 = App.Vector(0, top_t, z_top)          # Bottom front
    # p4 = App.Vector(0, bottom_t, z_base)      # Top front

    # points += [p1, p2, p3, p4, p1]

# Finish top against batten
z_top_final = num_boards * visible_height
points.append(App.Vector(0, 0, z_top_final))
...
board = doc.addObject("Part::Feature", "Weatherboards")
board.Shape = solid
cladding_part.addObject(board)

# Placement
board.Placement = App.Placement(App.Vector(0, clad_y_offset, 0), App.Rotation())
