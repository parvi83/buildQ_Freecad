...
at <https://crowdin.com/project/freecad-addons> webpage and find the **buildQ_module** project.

## Creating file for missing locale

### Using script

To create a file for a new language with all **buildQ_module** translatable strings execute
...
Also you can rename new `buildQ_module.ts` file by appending the locale code,
...
once done, look for the **buildQ_module** project.
